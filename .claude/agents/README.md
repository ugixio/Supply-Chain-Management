...
| [calc-engineer](calc-engineer.md) | HOW/SPECIALTY | the Python tools layer (dormant: no Python in the repo since ADR-0037; activates with Phase M) | yes | python-precision-grpc, testing-quality, engineering-standards + domain skills |
