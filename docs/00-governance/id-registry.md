...
| Prefix | Area | Owning doc | Highest allocated |
|---|---|---|---|
| CPT | Supply-chain concepts & calculations | `docs/25-concepts/` (per-node files) | CPT-0102 |

Allocated so far: **CPT-0001 … CPT-0102**. CPT-0001..0025 = dept 03 (demand-planning);
...
**CPT-0093..0102 = dept 09 (compliance & regulatory)** — all eight `enforced`. CPT-0024/0025 are `draft` (specified in the
