...
| Prefix | Area | Owning doc | Highest allocated |
|---|---|---|---|
| CPT | Supply-chain concepts & calculations | `docs/25-concepts/` (per-node files) | CPT-0092 |

Allocated so far: **CPT-0001 … CPT-0092**. CPT-0001..0025 = dept 03 (demand-planning);
...
**CPT-0082..0092 = dept 13 (order management)** — all seven `enforced`. CPT-0024/0025 are `draft` (specified in the
