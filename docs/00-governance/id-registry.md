...
| Prefix | Area | Owning doc | Highest allocated |
|---|---|---|---|
| CPT | Supply-chain concepts & calculations | `docs/25-concepts/` (per-node files) | CPT-0081 |

Allocated so far: **CPT-0001 … CPT-0081**. CPT-0001..0025 = dept 03 (demand-planning);
...
**CPT-0071..0081 = dept 10 (risk management)** — all six `enforced`. CPT-0024/0025 are `draft` (specified in the
